...
public class WorkLoadController {
    ...
    public void initialize() {
        ...
        ArrayList<InfoToBarChart> statistics = connection.getWorkLoadInfoToBarChart(LocalDateTime.now().plusDays(1));
        for (int daysQuantity = 0; daysQuantity < 7; daysQuantity++) {
            ...
            statistics = connection.getWorkLoadInfoToBarChart(LocalDateTime.now().minusDays(daysQuantity));
        }
